...
from .modules import BiDeNBartModel


MODEL_CLASSES = {
    'bart': (BartConfig, BiDeNBartModel, BartPretrainedModel, BartTokenizerFast)
}

model_class, config_class, pretrained_model_class, tokenizer_class = MODEL_CLASSES[args.model_type]


class SummarizationModel(BartPretrainedModel):
    base_model_prefix = "model"
    _keys_to_ignore_on_load_missing = [r"final_logits_bias", r"lm_head\.weight"]

    def __init__(self, config: BartConfig):
        super().__init__(config)
        self.model = BiDeNBartModel(config)
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            decoder_masks_dict=decoder_masks_dict,
            head_mask=head_mask,
